  ...
  <div class="container py-5">
    <div class="row mb-4">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="https://www.neslazeno.cz/wp-content/uploads/2018/06/unknown_profile-300x300.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          <h5 class="mb-0"><li>{{ $a }}</li></h5><span class="small text-uppercase text-muted">CEO - Founder</span>
